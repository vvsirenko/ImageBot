    ...
    def build(self):
        ...
        conv_handler = ConversationHandler(
            ...
            states={
                ...
                BotStates.CREATE_PAYMENT: [
                    CallbackQueryHandler(payment.handler, pattern="^" + "do_payment" + "$"),
                ],
                BotStates.SAVE_PHOTO: [
                    MessageHandler(filters.PHOTO, photos.handler)
                ],
                BotStates.PHOTO_PROCESSING: [
                    CallbackQueryHandler(start.handler, pattern="^" + "go_back" + "$"),
                    CallbackQueryHandler(begin.handler, pattern="^" + "begin" + "$")
                ]
            },
            fallbacks=[
